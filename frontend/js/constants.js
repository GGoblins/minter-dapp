const contractAddress = "0x71fA3Af02ED34937e6282e7f81ca83029D16b78d"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Gh3ttoGoblins NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Welcome to the Gh3ttoGoblins NFT Army. This NFT collection is filled with really greedy goblins and the collection will be available on opensea. The 2000 nft owners are getting whitelisted for the next mint. The next mint date will be announced on our social-media chanels, "So stay up-to-date on our Socials". This collection wil be continued in a new project for the gh3ttogoblins. The first earnings of the project wil be moved in to the organisation of this project, to make the brand bigger and produce more NFTs for in the future, but also for better development of the website and to make the community stronger by giveaways etc. "Btw!!" This whole project is started by one student with zero knoledge for building an NFT collection, with a target to see what people want to give an Gh3tto-Goblin NFT. I make sure and promise to the army that there will be no intentions for scammery on this project. All other scam massages who are involved with this project will be deleted and be blocked. Lets start the project and find out what we can reach!';
